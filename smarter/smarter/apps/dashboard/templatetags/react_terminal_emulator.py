"""
Django template tags for the terminal emulator app.
"""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/terminal-emulator", templatetag_name=__name__)
"""
...
@register.simple_tag
def terminal_emulator_react_assets() -> AssetDict:
    """
