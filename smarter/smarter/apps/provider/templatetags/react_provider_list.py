"""
Django template tags for the provider list app.
"""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/provider-list", templatetag_name=__name__)
"""
...
static/react/@smarter/provider-list/.
