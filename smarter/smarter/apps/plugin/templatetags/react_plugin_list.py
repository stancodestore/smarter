"""
Django template tags for the plugin list app.
"""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/plugin-list", templatetag_name=__name__)
"""
...
static/react/@smarter/plugin-list/.
...
@register.simple_tag
def plugin_list_react_assets() -> AssetDict:
    """
