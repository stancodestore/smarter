"""
Django template tags for the authtoken list app.
"""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/authtoken-list", templatetag_name=__name__)
"""
...
static/react/@smarter/authtoken-list/.
...
@register.simple_tag
def authtoken_list_react_assets() -> AssetDict:
    """
