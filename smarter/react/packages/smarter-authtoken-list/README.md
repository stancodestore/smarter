# Smarter AuthTokens List React App

This is the source code for the AuthTokens List app located
at [http://localhost:9357/authtoken/](http://localhost:9357/authtoken/).

This component is served by Django. See also:

- [smarter.apps.authtoken.views.listview.view.AuthTokenListView](../../smarter/apps/authtoken/views/listview/view.py)
- [smarter.apps.authtoken.templatetags.react_authtoken_list.authtoken_list_react_assets](../../smarter/apps/authtoken/templatetags/react_authtoken_list.py)
- [templates/react/authtoken-list.html](../../smarter/templates/react/authtoken-list.html)

## Screen Shot

![AuthToken List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/authtoken-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-authtoken-list/manifest.json`
...
```json
{
  ...
  "_custom": {
    ...
    "config": {
      "cdnDeploy": false,
      "s3BucketPath": "s3://smarter.sh/react/smarter-authtoken-list/",
