/**
 * Main entry point for the Smarter AuthToken List React application.
...
if (!ApiUrl) throw new Error("AuthToken list API URL not found in root element attributes");
