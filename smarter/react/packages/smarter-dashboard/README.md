...
trouble shooting purposes. http://example.com/static/react/smarter-dashboard/manifest.json
...
![Dashboard Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/smarter-dashboard-screenshot.png)
