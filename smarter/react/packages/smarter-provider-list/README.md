# Smarter Providers List React App

This is the source code for the Providers List app located
at [http://localhost:9357/provider/](http://localhost:9357/provider/).

This component is served by Django. See also:

- [smarter.apps.provider.views.listview.view.ProviderListView](../../smarter/apps/provider/views/listview/view.py)
- [smarter.apps.provider.templatetags.react_provider_list.provider_list_react_assets](../../smarter/apps/provider/templatetags/react_provider_list.py)
- [templates/react/provider-list.html](../../smarter/templates/react/provider-list.html)

## Screen Shot

![Provider List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/provider-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-provider-list/manifest.json`
...
```json
{
  ...
  "_custom": {
    ...
    "config": {
      "cdnDeploy": false,
      "s3BucketPath": "s3://smarter.sh/react/smarter-provider-list/",
