/**
 * Main entry point for the Smarter Provider List React application.
...
const ApiUrl = rootEl.getAttribute("smarter-provider-list-api-url");

if (!ApiUrl) throw new Error("Provider list API URL not found in root element attributes");
